...
def generate_influencer_html(template_html_file, excel_file, output_html_file):
    ...
    random_words = ["content quality", "engagement rate", "follower count", "follower authenticity", "brand collaborations"]
...
# Example usage
template_html_file = './vidzy/broadUgc/vidzy5-template-broad.html'  # Path to your updated HTML template file
excel_file = './ugca-videaze-grs-ugc-italy.xlsx'  # Path to your Excel file

# niche_lower = 'arab'  # You can extract this from your Excel or use as variable
country_lower = 'italy'    # You can extract this from your Excel or use as variable
output_html_file = f'top-intagram-ugc-creators-in-{country_lower}.html'  # Dynamic output HTML file name
