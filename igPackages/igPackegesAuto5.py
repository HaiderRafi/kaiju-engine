...
excel_file = './igy-social-videase-beauty-usa.xlsx'  # Path to your Excel file
...
output_html_file = f'top-{niche_lower}-instagram-influencers-in-{country_lower}.html'  # Dynamic output HTML file name
