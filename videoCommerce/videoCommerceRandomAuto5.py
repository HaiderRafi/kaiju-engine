...
# -------------------------------------------------------------------
# for vidcom 
# cropping the floor version (Random version)
# 5 template
# can use in every sheet with (Random) order and 5 template
# $countVar$ 
...
# Example usage
template_html_file = './videoCommerce/videoCommerce5-template.html'  # Path to your updated HTML template file
excel_file = './rs-vidcom-ytinsta-arab-usa.xlsx'  # Path to your Excel file
