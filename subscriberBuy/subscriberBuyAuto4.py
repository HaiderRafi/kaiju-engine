...
def generate_influencer_html(template_html_file, excel_file, output_html_file):
    ...
    random_words = ["follower count", "average reel views", "gender ratio", "content quality", "average likes"]
...
# Example usage
template_html_file = 'subscriberBuy4-template.html'  # Path to your updated HTML template file
