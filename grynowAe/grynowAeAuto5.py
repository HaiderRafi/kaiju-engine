...
# Example usage
template_html_file = 'grynowAe5-template.html'  # Path to your updated HTML template file
excel_file = 'vid-soc-videase-ig-sb-beauty-5.xlsx'  # Path to your Excel file
