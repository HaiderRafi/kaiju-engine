...
# # Example usage
# template_html_file = 'videoCommerce5-template.html'  # Path to your updated HTML template file
# excel_file = 'rs-vidcom-ytinsta-travel-dubai.xlsx'  # Path to your Excel file

# niche_lower = 'travel'  # Extract from your Excel or use as a variable
# country_lower = 'dubai'  # Extract from your Excel or use as a variable
...
#     # Limit the influencer list to a maximum of 100
#     max_influencers = 100
#     if total_influencers > max_influencers:
#         total_influencers = max_influencers

#     # Round total influencers to the nearest 10
#     specified_values = {100, 90, 80, 70, 60, 50, 40, 30, 20, 10}
#     rounded_count = total_influencers if total_influencers in specified_values else (total_influencers // 10) * 10

#     # Update the influencer list based on rounded count
...
#     # List of words to randomize for PRandomVar
#     random_words = ["follower count", "average reel plays", "male-to-female follower ratio", "average post likes"]
#     prandom_var = ', '.join(random.sample(random_words, 4))  # Randomize 5 words
#     html_template = html_template.replace('$PRandomVar$', prandom_var)
...
#     # Process influencers in shuffled chunks
