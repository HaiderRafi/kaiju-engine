...
# Example usage
template_html_file = 'vidzy5-template.html'  # Path to your updated HTML template file
excel_file = 'rs-vidcom-ytinsta-sports-dubai.xlsx'  # Path to your Excel file

niche_lower = 'sports'  # You can extract this from your Excel or use as variable
