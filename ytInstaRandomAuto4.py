...
def generate_influencer_html(template_html_file, excel_file, output_html_file):
    ...
    random_words = ["follower count", "average reel views", "average likes", "content quality", "male-female audience ratio"
                    ]
...
# Example usage
template_html_file = 'ytInsta4-template.html'  # Path to your updated HTML template file
