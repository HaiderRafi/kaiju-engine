...
def generate_influencer_html(template_html_file, excel_file, output_folder):
    ...
    random_words = ["engagement rate", "follower count", "sentiment analysis", "average reel views", "average likes"]
    ...
    output_html_file = os.path.join(output_folder, f'best-{niche_for_file}-instagrammers-in-{country_for_file}.html')
...
# Example usage
template_html_file = './grs/grs5-template.html'  # Path to your updated HTML template file
