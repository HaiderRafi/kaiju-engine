...
# Example usage
template_html_file = 'igPackeges4-template.html'  # Path to your updated HTML template file
excel_file = 'vid-soc-videase-ig-sb-automobile.xlsx'  # Path to your Excel file
