...
def generate_influencer_html(template_html_file, excel_file, output_html_file):
    ...
    random_words = ["follower count", "average reels plays", "average likes on their post", "male-female follower ration"]
...
# Example usage
template_html_file = 'videase4-template.html'  # Path to your updated HTML template file
excel_file = 'vid-soc-videase-ig-imve-automobile.xlsx'  # Path to your Excel file
