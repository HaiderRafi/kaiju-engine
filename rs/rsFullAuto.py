...
def generate_influencer_html(template_html_file, excel_file, output_folder):
    ...
    random_words = ["follower count", "average reel plays", "content quality", "audience trust", "brand collaborations"]
    ...
    output_html_file = os.path.join(output_folder, f'best-{niche_for_file}-influencers-in-{country_for_file}.html')
...
# Example usage
template_html_file = './rs/rs5-template.html'  # Path to your updated HTML template file
