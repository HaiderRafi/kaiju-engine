...
# Example usage
template_html_file = 'videaze4-template.html'  # Path to your updated HTML template file
excel_file = 'vid-soc-comedy-40.xlsx'  # Path to your Excel file

niche_lower = 'comedy'  # You can extract this from your Excel or use as variable
