...
excel_file = './rs-vidcom-ytinsta-middle-east-abudhabi.xlsx'  # Path to your Excel file

niche_lower = 'middle-east'  # You can extract this from your Excel or use as variable
